...
(function(url, data) {
  ...
  class EksiRemoteRequest {
    ...
    /**
         ...
         * @return {Promise<string>} - A promise that resolves with the response of the request as a string.
         */
    ...
    /**
         ...
         * @return {Promise<string>} - A promise that resolves with the response of the GET request as a string.
         */
    async get(url) {
    ...
    /**
         ...
         * @return {Promise<string>} - A promise that resolves with the response of the POST request as a string.
         */
    async post(url, data = {}) {
  ...
  class EksiDOM {
    ...
    /**
         ...
         * @param {string} selector - The CSS selector to query
         * @param {HTMLElement} [context=document] - The context element to search within
         * @return {NodeList} - A list of elements matching the selector
         */
    ...
    /**
         ...
         * @return {boolean} - Whether the element has the class or not
         */
  ...
  class EksiHtmlParser {
    ...
    /**
         ...
         * @return {HTMLDocument} - The parsed HTML document object.
         */
    parseHtml(html) {
    ...
    /**
         ...
         * @return {Array<string>} - An array of URLs of the favorited users' profiles.
         */
  ...
  class EksiCSS {
    ...
    /**
         ...
         * @return {HTMLStyleElement} - The existing style tag
         */
    getStyleTag() {
    ...
    /**
         ...
         * @return {HTMLStyleElement} - The newly created style tag
         */
    createStyleTag() {
    ...
    /**
         ...
         * @return {boolean} - Whether the css already exists in the style tag or not
         */
    hasCSSAdded(css) {
  ...
  class EksiBlockUsers {
    ...
    /**
         ...
         * @return {Promise<Array<string>>} - A promise that resolves with the HTML response of the request for the list of favorited users.
         */
